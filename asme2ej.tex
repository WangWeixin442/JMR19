...
\begin{table*}[b]
	...
	\begin{center}
		...
		\begin{tabular}{c c c c} 
			\hline
			\hline
			\multirow{2}{*}{\textbf{Clutch motion}} &  \multicolumn{2}{ c }{\textbf{Allowable time interval}} & \multirow{2}{*}{\textbf{Underfoot pressure criteria}} \\ \cline{2-3}&\textbf{Start from} & \textbf{End before}\\
			\hline
