...
The working process of the exoskeleton in a gait cycle is shown in Fig. \ref{fig:workprocess}, where 0\% and 100\% correspond to two successive heel strikes, \textcolor{red}{and 60\% corresponds roughly to toe off}.
...
\begin{table*}[b]
	...
	\begin{center}
		...
		\begin{tabular}{c c c c} 
			\hline
			\hline
			\multirow{2}{*}{\textbf{Clutch motion}} &  \multicolumn{2}{ c }{\textbf{Allowable time interval} (\textcolor{red}{\% gait cycle})} & \multirow{2}{*}{\shortstack{\textbf{Plantar pressure criteria} \\ 
			(55 strides per minute)}} \\ \cline{2-3}&\textbf{Start from} & \textbf{End before}\\
			\hline
			Ankle clutch locks & \tabincell{c}{End of push-off \\ \textcolor{red}{(60\%)}} & \tabincell{c}{Beginning of knee extension \\ \textcolor{red}{(75\%)}} & \tabincell{c}{0.1s after plantar \\ pressure disappears}\\
			Knee clutch locks & \tabincell{c}{Beginning of knee extension \\ \textcolor{red}{(75\%)}} & \tabincell{c}{Heel strike \\ \textcolor{red}{(100\%)}} &\tabincell{c}{0.2s after plantar\\ pressure disappears}\\
			Ankle clutch unlocks & \tabincell{c}{Ankle in its neutral position \\ \textcolor{red}{(around 25\%)}} & \tabincell{c}{Beginning of push-off \\ \textcolor{red}{(40 \%)}} &\tabincell{c}{0.1s after forefoot\\ pressure appears}\\
			Knee clutch unlocks & \tabincell{c}{End of push-off \\ \textcolor{red}{(60\%)}} & \tabincell{c}{End of push-off \\ \textcolor{red}{(60\%)}} &\tabincell{c}{Right after plantar \\ pressure disappears} \\
			\hline
			\hline
		\end{tabular}
	\end{center}
...
More specifically, the ankle and knee clutches should lock between \textcolor{red}{60\% to 75\%, and 75\% to 100\% of a gait cycle (roughly 0s-0.2s and 0.2s-0.4s after toe off)}, which motivates the choices of the time delays listed in Table \ref{tab:control} after considering the delay in the mechanical system.
...
\textcolor{red}{The choices of time delays are justified by wearers walking with the exoskeleton in a natural manner.}
...
\textcolor{red}{The total joint moments were those obtained from the inverse dynamics analysis, and the total joint power was calculated by the dot product of the joint velocity and moment.}
...
The average peak force in the knee rope (blue line) was 55$\pm$6 N, indicating the spring was stretched \textcolor{red}{by the knee joint, and therefore some energy was stored in the torsion spring} in late swing.
...
In the second stage, the slope became milder, indicating the spring was stretched again \textcolor{red}{by the ankle} and began to \textcolor{red}{store energy}.
...
\textcolor{red}{These reductions partly verified the expected outcome (i).}
...
\textcolor{red}{There results correspond to the expected outcome (ii).}
...
From these reductions \textcolor{red}{which verified expected outcome (iii)}, it can be concluded that the exoskeleton supplied the harvested energy to assist ankle plantar flexion in late stance.
...
\textcolor{red}{The average joint angles, moments and power which appeared different were tested, however, all of the differences were not significant among the three conditions for the left leg, thus the data are omitted here.}
